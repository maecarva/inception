...
wp config create --dbname=inceptiondb --dbuser="$DB_USER" --dbpass="$DB_PASSWORD" --dbhost=mariadb:3306 --force

wp core is-installed || wp core install --url=maecarva.42.fr --title="Inception" --admin_user="$WP_USER1" \
